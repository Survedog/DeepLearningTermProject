...
class UtilsTests(unittest.TestCase):
    ...
    def test_create_corpus_and_dict(self):
        ...
        self.assertTrue(np.array_equal(corpus, corpus2))
    ...
    def test_load_essay_data(self):
        train_data = load_essay_data(load_test_data=False, load_pickle=False)
        test_data = load_essay_data(load_test_data=True, load_pickle=False)
        self.assertTrue(train_data)
        self.assertTrue(test_data)

        train_data = load_essay_data(load_test_data=False, load_pickle=True)
        test_data = load_essay_data(load_test_data=True, load_pickle=True)
        self.assertTrue(train_data)
        self.assertTrue(test_data)
