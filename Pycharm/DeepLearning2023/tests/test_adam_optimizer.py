...
class AdamOptimizerTests(unittest.TestCase):
    ...
    def test_update(self):
        ...
        self.assertTrue(np.array_equal(w1 < w1_old, g1 > 0.0))
        self.assertTrue(np.array_equal(w1 > w1_old, g1 < 0.0))
        self.assertTrue(np.array_equal(w2 < w2_old, g2 > 0.0))
        self.assertTrue(np.array_equal(w2 > w2_old, g2 < 0.0))
        ...
        self.assertFalse(np.array_equal(w1, w1_old))
        self.assertFalse(np.array_equal(w2, w2_old))
